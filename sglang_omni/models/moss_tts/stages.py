...
def create_preprocessing_executor(
    ...
    *,
    ...
    # Reference encoding dominates MOSS preprocessing. Keep several requests in
    # flight so the AR engine receives a steady, batchable stream; by default the
    # audio tokenizer itself lives on GPU and CPU-only environments fall back
    # above before loading the processor.
